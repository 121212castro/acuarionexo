...
(function(){
  ...
  function injectStyle(){
    ...
    st.textContent=`
      ...
      .tank-more-panel{display:none;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:8px}.tank-more-panel.open{display:grid}.tank-more-panel button{border-radius:15px!important;padding:10px!important;font-size:13px!important;background:rgba(16,52,85,.70)!important}.param-screen{margin-top:10px}.param-screen h2{font-size:24px;margin-bottom:8px}.param-live-head{font-size:14px!important;line-height:1.35!important;margin-top:0!important}.param-card-grid{grid-template-columns:repeat(auto-fit,minmax(138px,1fr))!important}.param-card{position:relative;overflow:hidden;min-height:104px!important;padding:12px!important;background:linear-gradient(180deg,rgba(20,50,78,.96),rgba(8,27,48,.96))!important;border:1px solid rgba(145,205,255,.22)!important}.param-card:before{content:"";position:absolute;left:0;top:0;bottom:0;width:7px;background:#7f9bb7}.param-card:after{content:"";position:absolute;right:10px;top:10px;width:11px;height:11px;border-radius:999px;background:#7f9bb7;box-shadow:0 0 16px currentColor}.pc-value{font-size:24px!important}.pc-value small{font-size:13px!important;color:#bdd7ed!important}.pc-status{font-size:12px!important}.pc-original{font-size:11px!important}
      .param-green{background:linear-gradient(180deg,rgba(10,76,48,.96),rgba(5,36,31,.96))!important;border-color:rgba(46,232,124,.52)!important}.param-green:before,.param-green:after{background:#2ee87c}.param-green .pc-status{background:rgba(46,232,124,.18)!important;color:#caffdd!important;border:1px solid rgba(46,232,124,.32)!important}
      .param-blue{background:linear-gradient(180deg,rgba(12,73,112,.96),rgba(6,38,69,.96))!important;border-color:rgba(56,189,248,.52)!important}.param-blue:before,.param-blue:after{background:#38bdf8}.param-blue .pc-status{background:rgba(56,189,248,.18)!important;color:#d6f5ff!important;border:1px solid rgba(56,189,248,.32)!important}
      .param-yellow{background:linear-gradient(180deg,rgba(93,77,10,.96),rgba(47,39,7,.96))!important;border-color:rgba(255,209,47,.62)!important}.param-yellow:before,.param-yellow:after{background:#ffd12f}.param-yellow .pc-status{background:rgba(255,209,47,.20)!important;color:#fff4bd!important;border:1px solid rgba(255,209,47,.38)!important}
      .param-orange{background:linear-gradient(180deg,rgba(110,58,14,.96),rgba(56,28,8,.96))!important;border-color:rgba(251,146,60,.62)!important}.param-orange:before,.param-orange:after{background:#fb923c}.param-orange .pc-status{background:rgba(251,146,60,.20)!important;color:#ffdfc4!important;border:1px solid rgba(251,146,60,.38)!important}
      .param-red{background:linear-gradient(180deg,rgba(106,23,37,.96),rgba(52,10,21,.96))!important;border-color:rgba(255,85,112,.70)!important}.param-red:before,.param-red:after{background:#ff5570}.param-red .pc-status{background:rgba(255,85,112,.22)!important;color:#ffd2da!important;border:1px solid rgba(255,85,112,.42)!important}
      .param-purple{background:linear-gradient(180deg,rgba(88,28,135,.96),rgba(44,15,73,.96))!important;border-color:rgba(216,180,254,.72)!important}.param-purple:before,.param-purple:after{background:#d8b4fe}.param-purple .pc-status{background:rgba(216,180,254,.22)!important;color:#f3e8ff!important;border:1px solid rgba(216,180,254,.42)!important}
