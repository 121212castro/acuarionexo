...
export const contracts: Record<string, string[]> = {
  ...
  microfauna: ["title","scientific_name","common_names","culture_type","identification","use_in_aquarium","target_animals","culture_method","container","temperature_min","temperature_max","salinity_min","salinity_max","feeding","feeding_frequency","harvest","harvest_frequency","maintenance","water_changes","density_control","crash_risks","contamination_risks","storage","care_level","common_problems","common_mistakes","sources"],
  producto: ["title","manufacturer","brand","product_code","category","composition","active_components","intended_use","dose","dose_calculation","use","instructions","monitoring","compatibility","risks","warnings","storage","expiry","aquarium_type","source_label","sources"],
  sal: ["title","manufacturer","brand","product_code","composition","declared_parameters","salinity_reference","grams_per_liter","mixing","mixing_time","dose","dose_calculation","use","water_change_use","monitoring","compatibility","risks","storage","expiry","aquarium_type","source_label","sources"],
  aditivo: ["title","manufacturer","brand","product_code","composition","active_components","what_corrects","parameter_target","dose","dose_calculation","maximum_dose","use","instructions","monitoring","compatibility","risks","warnings","storage","expiry","aquarium_type","source_label","sources"],
  alimento: ["title","manufacturer","brand","product_code","food_type","composition","analysis","particle_size","target_species","feeding_frequency","dose","use","instructions","compatibility","risks","storage","expiry","aquarium_type","source_label","sources"],
  medicamento: ["title","manufacturer","brand","product_code","active_ingredient","indications","target_diseases","dose","dose_calculation","treatment_days","repeat_treatment","remove_equipment","water_change_after","monitoring","compatibility","contraindications","risks","warnings","storage","expiry","hospital_tank_use","source_label","sources"],
  test: ["title","manufacturer","brand","product_code","parameter","method","range","resolution","scale_values","sample_volume","reagents","procedure","reading_time","interpretation","interferences","expiry","storage","compatibility","acuarionexo_mapping","common_errors","source_label","sources"],
  equipamiento: ["title","manufacturer","brand","product_code","equipment_type","specifications","power","consumption_watts","flow","volume","tank_size_recommended","installation","setup","maintenance","cleaning_frequency","spare_parts","compatibility","risks","warnings","warranty","source_manual","sources"]
};
