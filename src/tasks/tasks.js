...
(function () {
  ...
  const { cleanParamText, cleanStatus, taskMeta, taskNotes, taskNotesPayload, taskRoute, openTaskTarget, repeatOptions, renderTaskSections, refreshAfterTaskDone } = window.ANX;
