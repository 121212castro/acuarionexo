...
(function (root, factory) {
  ...
  const LABELS = {
    ...
    family: 'Familia', order_name: 'Orden', class_name: 'Clase', distribution: 'Distribución', habitat: 'Hábitat natural', depth_range: 'Profundidad', natural_environment: 'Entorno natural',
  ...
  function sectionFor(field) {
    ...
    if (['title','scientific_name','common_names','synonyms','manufacturer','brand','product_code','family','order_name','class_name','category','equipment_type','food_type','culture_type','coral_type','plant_type','identification','test_type','intended_use','parameter','measured_ion_or_compound','reading_unit'].includes(field)) return 'identity';
    ...
    if (/maintenance|trimming|fertilization|co2|cleaning_after_use|cleaning_frequency/.test(field)) return 'maintenance';
