(function(){
  const bg='assets/fondos/fondo-ficha-oficial.svg?v=oficial-1';
  window.fichaPremium=function(tipo,src,titulo){
    const sujeto=src?'<img src="'+src+'" class="ficha-sujeto">':'<div class="ficha-vacia">Fondo oficial listo<br>sin sujeto fijo</div>';
    return '<div class="ficha-premium-oficial"><div class="ficha-bg-oficial" style="background-image:url('+bg+')">'+sujeto+'</div></div>';
  };
