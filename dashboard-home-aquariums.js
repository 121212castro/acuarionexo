window.AcuarioNexoDashboardHomeAquariums={version:'dashboard-home-aquariums-24-05-data-safe-compact'};
(function(){
  ...
  async function fetchAquariumsSafe(){
    if(!window.s)return [];
    var columns='id,name,aquarium_type,subtype,real_liters,liters,cover_url,photo_url,image_url,main_photo_url,created_at,user_id';
